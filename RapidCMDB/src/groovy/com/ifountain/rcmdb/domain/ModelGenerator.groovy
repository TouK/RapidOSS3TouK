            ...
            else
            {
                ...
                modelFile.eachLine {line->
                    ...
                    else if(classParts == 0 && line.matches(classLinePattern))
                    {
                        ...
                        String implementsPart = line.replaceAll(classDefinitionReplacementPattern, " ");
                        if(implementsPart.indexOf(" implements ") >= 0)
                        {
                            if(implementsPart.indexOf(GeneratedModel.class.name) < 0)
                            {
                                implementsPart = implementsPart.replaceAll(" implements ", " implements ${GeneratedModel.class.name}, ")    
                            }
                        }
                        else
                        {
                            implementsPart = " implements ${GeneratedModel.class.name} " + implementsPart;                            
                        }
                        classDefinition += implementsPart;
