            ...
            <table>
                <tbody>
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" class="value ${hasErrors(bean:rsHistoricalEvent,field:'elementId','errors')}">
                            <input type="text" id="elementId" name="elementId" value="${fieldValue(bean:rsHistoricalEvent,field:'elementId')}" />
                        </td>
                    </tr>
