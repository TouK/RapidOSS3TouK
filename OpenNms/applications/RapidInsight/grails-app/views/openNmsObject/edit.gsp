...
<head>
    ...
    <title>Edit OpenNmsObject</title>
</head>
<body>
<div class="nav">
            ...
            <table>
                <tbody>
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" class="value ${hasErrors(bean:openNmsObject,field:'graphs','errors')}">
                            
<ul>
<g:each var="g" in="${openNmsObject?.graphs?}">
    <li style="margin-bottom:3px;">
        <g:link controller="openNmsGraph" action="show" id="${g.id}">${g}</g:link>
        <g:link class="delete" action="removeRelation" params="['id':openNmsObject?.id, 'relationName':'graphs', 'relatedObjectId':g.id]"></g:link>
    </li>
</g:each>
</ul>
<g:link params="['id':openNmsObject?.id, 'relationName':'graphs']" action="addTo">Add OpenNmsGraph</g:link>
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" class="value ${hasErrors(bean:openNmsObject,field:'memberOfGroup','errors')}">
                            
<ul>
<g:each var="m" in="${openNmsObject?.memberOfGroup?}">
    <li style="margin-bottom:3px;">
        <g:link controller="rsGroup" action="show" id="${m.id}">${m}</g:link>
        <g:link class="delete" action="removeRelation" params="['id':openNmsObject?.id, 'relationName':'memberOfGroup', 'relatedObjectId':m.id]"></g:link>
    </li>
</g:each>
</ul>
<g:link params="['id':openNmsObject?.id, 'relationName':'memberOfGroup']" action="addTo">Add RsGroup</g:link>
