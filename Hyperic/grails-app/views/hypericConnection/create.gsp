...
<html>
    <head>
        ...
        <title>Create HypericConnection</title>
    </head>
    <body>
        <div class="nav">
        ...
        <div class="body">
            <h1>Create HypericConnection</h1>
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:hypericConnection,field:'name','errors')}">
                                    <input type="text" class="inputtextfield" id="name" name="name" value="${fieldValue(bean:hypericConnection,field:'name')}"/>
                                </td>
                            </tr> 
