...
public class DefaultReindexMethod extends DefaultIndexMethod implements SearchableMethod {
    ...
    public DefaultReindexMethod(String methodName, Compass compass, CompassGps compassGps, Map defaultOptions) {
        super(methodName, compass, compassGps, defaultOptions);
        unindexMethod = new DefaultUnindexMethod(methodName, compass, defaultOptions);
    }

    public DefaultReindexMethod(String methodName, Compass compass, CompassGps compassGps) {
