...
public class GetRelationTypesActionTest extends SmartsTestCase {
    ...
    public void testExecute() throws Exception {
        ...
        datasource._connect();
        action.execute(datasource);
        int[] expected = datasource.getDomainManager().getRelationTypes(className);
        assertTrue(Arrays.equals(expected, action.getRelationTypes()));
