...
public class FileMerger
{
	...
	public boolean isYahooFile(String filePath)
	{
		if((filePath.indexOf("YAHOO.js") >= 0) || (filePath.indexOf("yui-ext.css") >= 0) || filePath.indexOf("RSHelp.js") >=0)
		{
			return true;
		}
		return false;
