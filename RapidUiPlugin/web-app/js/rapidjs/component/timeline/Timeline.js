...
Timeline._Impl.prototype._initialize = function() {
    ...
    var elmtCopyright = Timeline.Graphics.createTranslucentImage(doc, Timeline.urlPrefix + (this.isHorizontal() ? "RapidSuite/images/rapidjs/component/timeline/copyright-vertical.png" : "RapidSuite/images/rapidjs/component/timeline/copyright.png"));
    ...
    message.contentDiv.innerHTML = "<img src='" + Timeline.urlPrefix + "RapidSuite/images/rapidjs/component/timeline/progress-running.gif' /> Loading...";
...
Timeline.Graphics.createMessageBubble = function(doc) {
    ...
    if (Timeline.Graphics.pngIsTranslucent) {
        ...
        topDiv.style.background = "url(" + Timeline.urlPrefix + "RapidSuite/images/rapidjs/component/timeline/message-top-left.png) top left no-repeat";
        topDiv.style.paddingLeft = "44px";
        containerDiv.appendChild(topDiv);

        var topRightDiv = doc.createElement("div");
        topRightDiv.style.height = "33px";
        topRightDiv.style.background = "url(" + Timeline.urlPrefix + "RapidSuite/images/rapidjs/component/timeline/message-top-right.png) top right no-repeat";
        topDiv.appendChild(topRightDiv);

        var middleDiv = doc.createElement("div");
        middleDiv.style.background = "url(" + Timeline.urlPrefix + "RapidSuite/images/rapidjs/component/timeline/message-left.png) top left repeat-y";
        middleDiv.style.paddingLeft = "44px";
        containerDiv.appendChild(middleDiv);

        var middleRightDiv = doc.createElement("div");
        middleRightDiv.style.background = "url(" + Timeline.urlPrefix + "RapidSuite/images/rapidjs/component/timeline/message-right.png) top right repeat-y";
        ...
        bottomDiv.style.background = "url(" + Timeline.urlPrefix + "RapidSuite/images/rapidjs/component/timeline/message-bottom-left.png) bottom left no-repeat";
        bottomDiv.style.paddingLeft = "44px";
        containerDiv.appendChild(bottomDiv);

        var bottomRightDiv = doc.createElement("div");
        bottomRightDiv.style.height = "55px";
        bottomRightDiv.style.background = "url(" + Timeline.urlPrefix + "RapidSuite/images/rapidjs/component/timeline/message-bottom-right.png) bottom right no-repeat";
...
Timeline.ClassicTheme._Impl = function() {
    ...
    this.event = {
        ...
        instant:{
            icon:Timeline.urlPrefix + "RapidSuite/images/rapidjs/component/timeline/dull-blue-circle.png",
            lineColor:"#58A0DC",
