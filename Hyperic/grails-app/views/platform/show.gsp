        ...
        <table>
            <tbody>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${platform.id}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${platform.resource_name}</td>
                    
                </tr>
                
                <tr class="prop">
                    <td valign="top" class="name">hasServers:</td>
                    
                    <td valign="top" style="text-align:left;" class="value">
                        <ul>
                            <g:each var="h" in="${platform.hasServers}">
                                <li><g:link controller="server" action="show" id="${h.id}">${h}</g:link></li>
                            </g:each>
                        </ul>
                    </td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${platform.status}</td>
