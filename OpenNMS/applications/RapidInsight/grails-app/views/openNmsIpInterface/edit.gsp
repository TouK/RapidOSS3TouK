...
<head>
    ...
    <title>Edit OpenNmsIpInterface</title>
</head>
<body>
<div class="nav">
            ...
            <table>
                <tbody>
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" class="value ${hasErrors(bean:openNmsIpInterface,field:'graphs','errors')}">
                            
<ul>
<g:each var="g" in="${openNmsIpInterface?.graphs?}">
    <li style="margin-bottom:3px;">
        <g:link controller="openNmsGraph" action="show" id="${g.id}">${g}</g:link>
        <g:link class="delete" action="removeRelation" params="['id':openNmsIpInterface?.id, 'relationName':'graphs', 'relatedObjectId':g.id]"></g:link>
    </li>
</g:each>
</ul>
<g:link params="['id':openNmsIpInterface?.id, 'relationName':'graphs']" action="addTo">Add OpenNmsGraph</g:link>
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" class="value ${hasErrors(bean:openNmsIpInterface,field:'services','errors')}">
                            
<ul>
<g:each var="s" in="${openNmsIpInterface?.services?}">
    <li style="margin-bottom:3px;">
        <g:link controller="openNmsService" action="show" id="${s.id}">${s}</g:link>
        <g:link class="delete" action="removeRelation" params="['id':openNmsIpInterface?.id, 'relationName':'services', 'relatedObjectId':s.id]"></g:link>
    </li>
</g:each>
</ul>
<g:link params="['id':openNmsIpInterface?.id, 'relationName':'services']" action="addTo">Add OpenNmsService</g:link>
