...
<html>
    <head>
        ...
        <title>Add To SmartsComputerSystem</title>
    </head>
    <body>
        <div class="nav">
        ...
        <div class="body">
            <h1>Add To SmartsComputerSystem</h1>
                        ...
                        <tbody>
                            <tr class="prop">
                                <td valign="top" class="name">
                                    ...
                                    <label for="${relationName}">${com.ifountain.rcmdb.domain.util.DomainClassUtils.getStaticMapVariable(smartsComputerSystem.class, "relations")[relationName]?.type.getName()}:</label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: smartsComputerSystem, field: relationName, 'errors')}">
