...
YAHOO.rapidjs.component.FlexApplication.prototype =
{
    ...
    _render: function()
    {
        ...
        var objectString = "<object classid='clsid:D27CDB6E-AE6D-11cf-96B8-444553540000' \
							...
							<param value='eventHandler=flexApplicationEventHandler&appId=" + this.flexObjectId+"' name='flashvars'/> \
							<embed src='"+this.swfUrl+"' id='"+this.flexEmbedId+"' quality='high' \
								width='100%' height='100%' name='"+this.flexEmbedId+"' align='middle' \
								play='true'  \
								loop='false' \
								flashvars='eventHandler=flexApplicationEventHandler&appId=" + this.flexObjectId+"' \
								quality='high' \
								swliveconnect='true' \
								wmode = 'Transparent' \
