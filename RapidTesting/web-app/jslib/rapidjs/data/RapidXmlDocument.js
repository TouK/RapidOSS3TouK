...
YAHOO.extendX(YAHOO.rapidjs.data.RapidXmlNode, YAHOO.rapidjs.data.Node, {
	createChildNode: function(xmlNode, nodeType, nodeName)
	 {
...
YAHOO.extendX(YAHOO.rapidjs.data.RapidJsonNode, YAHOO.rapidjs.data.Node, {
	 createChildNodes: function(xmlNode)
	 {
	 	this.attributes={};
	 	this.children = [];
