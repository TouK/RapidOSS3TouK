...
class CompassSortingTest extends RapidCmdbWithCompassTestCase {
    ...
    public void testSortingWithMultipleFields()
    {
        initialize([CompassTestObject], [], false);
        def insts = [
                CompassTestObject.add(prop1: "prop1value3", prop2: "prop2value2"),
                CompassTestObject.add(prop1: "prop1value3", prop2: "prop2value1"),
                CompassTestObject.add(prop1: "prop1value3", prop2: "prop2value3"),
                CompassTestObject.add(prop1: "prop1value2", prop2: "prop2value2"),
                CompassTestObject.add(prop1: "prop1value2", prop2: "prop2value1"),
                CompassTestObject.add(prop1: "prop1value2", prop2: "prop2value3"),
                CompassTestObject.add(prop1: "prop1value1", prop2: "prop2value2"),
                CompassTestObject.add(prop1: "prop1value1", prop2: "prop2value1"),
                CompassTestObject.add(prop1: "prop1value1", prop2: "prop2value3"),

        ]
        assertEquals(insts.size(), CompassTestObject.count());
        def returnedObjects = CompassTestObject.search("alias:*", [sort: "prop1,  prop2"]).results
        insts = insts.sort {obj1, obj2 ->
            def obj1prop1 = obj1.prop1.toLowerCase();
            def obj2prop1 = obj2.prop1.toLowerCase();
            return obj1prop1 > obj2prop1 ? 1 : obj2prop1 > obj1prop1 ? -1 : obj1.prop2.toLowerCase() > obj2.prop2.toLowerCase() ? 1 : -1;
        }
        for (int i = 0; i < insts.size(); i++)
        {
            def expectedInstance = insts[i]
        ...
        returnedObjects = CompassTestObject.search("alias:*", [sort: ["prop1", "prop2"]]).results
        for (int i = 0; i < insts.size(); i++)
        {
            def expectedInstance = insts[i]
            assertEquals(expectedInstance.id, returnedObjects[i].id)
        }
        returnedObjects = CompassTestObject.search("alias:*", [sort: ["prop1", "prop2"], order: "asc, asc"]).results
        ...
        returnedObjects = CompassTestObject.search("alias:*", [sort: "prop1,  prop2", order: ["desc", "desc"]]).results
        insts = insts.sort {obj1, obj2 ->
            def obj1prop1 = obj1.prop1.toLowerCase();
            def obj2prop1 = obj2.prop1.toLowerCase();
            return obj1prop1 < obj2prop1 ? 1 : obj2prop1 < obj1prop1 ? -1 : obj1.prop2.toLowerCase() < obj2.prop2.toLowerCase() ? 1 : -1;
