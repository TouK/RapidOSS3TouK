...
<rui:include template="pageContents/renderer/_renderQueryButtons.gsp" model="[componentName:'filterTree', queryType:'historicalEvent', searchComponentType:'list',searchComponentName:'eventList']"></rui:include>
<script>
    filterTree.poll();
    eventList.poll();
</script>