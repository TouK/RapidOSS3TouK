...
JAVA_OPTS=" -Xmx"$MAX_MEMORY_SIZE"m -Ddisable.auto.recompile=true -Dserver.port=12223 -Dgrails.work.dir=$RS_HOME/temp/modeler -Dgrails.env=production -Dgroovy.sanitized.stacktraces=groovy.,org.codehaus.groovy.,java.,javax.,sun.,gjdk.groovy.,org.springframework.,org.mortbay.,net.sf., -Dgroovy.full.stacktrace=false -Drcmdb.excluded.tests=ExcludedTests.txt -Drs.modeler=true $JAVA_OPTS"
