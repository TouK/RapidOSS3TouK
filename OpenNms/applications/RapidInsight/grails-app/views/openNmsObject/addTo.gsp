...
<html>
    <head>
        ...
        <title>Add To OpenNmsObject</title>
    </head>
    <body>
        <div class="nav">
                        ...
                        <tbody>
                            <tr class="prop">
                                <td valign="top" class="name">
                                    ...
                                    <label for="${relationName}">${com.ifountain.rcmdb.domain.util.DomainClassUtils.getStaticMapVariable(openNmsObject.class, "relations")[relationName]?.type.getName()}:</label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: openNmsObject, field: relationName, 'errors')}">
