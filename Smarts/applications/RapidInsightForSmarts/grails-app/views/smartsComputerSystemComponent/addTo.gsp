...
<html>
    <head>
        ...
        <title>Add To SmartsComputerSystemComponent</title>
    </head>
    <body>
        <div class="nav">
        ...
        <div class="body">
            <h1>Add To SmartsComputerSystemComponent</h1>
                        ...
                        <tbody>
                            <tr class="prop">
                                <td valign="top" class="name">
                                    ...
                                    <label for="${relationName}">${com.ifountain.rcmdb.domain.util.DomainClassUtils.getStaticMapVariable(smartsComputerSystemComponent.class, "relations")[relationName]?.type.getName()}:</label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: smartsComputerSystemComponent, field: relationName, 'errors')}">
