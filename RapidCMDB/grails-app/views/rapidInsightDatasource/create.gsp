                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:rapidInsightDatasource,field:'name','errors')}">
                                    <input type="text" id="name" name="name" value="${fieldValue(bean:rapidInsightDatasource,field:'name')}"/>
                                </td>
                            </tr> 
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:rapidInsightDatasource,field:'connection','errors')}">
                                    <g:select optionKey="id" from="${connection.RapidInsightConnection.list()}" name="connection.id" value="${rapidInsightDatasource?.connection?.id}" ></g:select>
                                </td>
                            </tr> 
