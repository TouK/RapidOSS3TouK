...
<html>
    <head>
        ...
        <title>Add To NetcoolColumn</title>
    </head>
    <body>
        <div class="nav">
                        ...
                        <tbody>
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="${relationName}">${netcoolColumn.hasMany[relationName]?.getName()}:</label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: netcoolColumn, field: relationName, 'errors')}">
