                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:httpDatasource,field:'name','errors')}">
                                    <input type="text" id="name" name="name" value="${fieldValue(bean:httpDatasource,field:'name')}"/>
                                </td>
                            </tr> 
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:httpDatasource,field:'connection','errors')}">
                                    <g:select optionKey="id" from="${connection.HttpConnection.list()}" name="connection.id" value="${httpDatasource?.connection?.id}" ></g:select>
                                </td>
                            </tr> 
