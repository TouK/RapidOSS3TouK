...
<head>
    ...
    <title>Edit SmartsNotification</title>
</head>
<body>
<div class="nav">
            ...
            <table>
                <tbody>
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" class="value ${hasErrors(bean:smartsNotification,field:'causedBy','errors')}">
                            
<ul>
<g:each var="c" in="${smartsNotification?.causedBy?}">
    <li style="margin-bottom:3px;">
        <g:link controller="smartsNotification" action="show" id="${c.id}">${c}</g:link>
        <g:link class="delete" action="removeRelation" params="['id':smartsNotification?.id, 'relationName':'causedBy', 'relatedObjectId':c.id]"></g:link>
    </li>
</g:each>
</ul>
<g:link params="['id':smartsNotification?.id, 'relationName':'causedBy']" action="addTo">Add SmartsNotification</g:link>
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" class="value ${hasErrors(bean:smartsNotification,field:'causes','errors')}">
                            
<ul>
<g:each var="c" in="${smartsNotification?.causes?}">
    <li style="margin-bottom:3px;">
        <g:link controller="smartsNotification" action="show" id="${c.id}">${c}</g:link>
        <g:link class="delete" action="removeRelation" params="['id':smartsNotification?.id, 'relationName':'causes', 'relatedObjectId':c.id]"></g:link>
    </li>
</g:each>
</ul>
<g:link params="['id':smartsNotification?.id, 'relationName':'causes']" action="addTo">Add SmartsNotification</g:link>
