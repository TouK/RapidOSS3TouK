...
<html>
    ...
    <body>
        ...
        <div class="body">
            ...
            <g:render template="/common/messages" model="[flash:flash, beans:[sametimeConnection]]"></g:render>
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:sametimeConnection,field:'community','errors')}">
                                    <input class="inputtextfield" id="community" name="community" value="${fieldValue(bean:sametimeConnection,field:'community')}"/>
                                </td>
                            </tr>
