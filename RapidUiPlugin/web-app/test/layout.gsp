...
<link rel="stylesheet" type="text/css" href="../riindex.css"/>
  ...
  <body>
    <rui:layout id="5">
        <rui:layoutUnit position="center"  scroll="false" gutter="">
                <rui:innerLayout id="6">
                    <rui:layoutUnit position="center"  scroll="false" gutter="" body="mydiv">
                    </rui:layoutUnit>
                </rui:innerLayout>
        </rui:layoutUnit>
        <rui:layoutUnit position="bottom"   scroll="false" gutter="" height="200" resize="true">
                <rui:innerLayout id="6">
                    <rui:layoutUnit position="center"  scroll="false" gutter="" body="mydiv2">
                    </rui:layoutUnit>
                </rui:innerLayout>
        </rui:layoutUnit>
    </rui:layout>
  ...
  <div id="mydiv2" style="background-color:green;width:100px;height:100px">
