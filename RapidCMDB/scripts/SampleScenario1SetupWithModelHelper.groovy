...
def bday = [name:"bday", type:ModelProperty.dateType, blank:false, lazy:false, propertyDatasource:"RCMDB"];
props.add(name);
props.add(bday);
...
modelhelperEmployee.createRelation("Employee", "prevEmp", "nextEmp", ModelRelation.ONE, ModelRelation.ONE);
modelhelperEmployee.createRelation("Employee", "employees", "manager", ModelRelation.ONE, ModelRelation.MANY);
modelhelperEmployee.createRelation("Team", "manages", "managedBy", ModelRelation.ONE, ModelRelation.MANY);
modelhelperDeveloper.createRelation("Task", "worksOn", "workedOnBy", ModelRelation.MANY, ModelRelation.MANY);
