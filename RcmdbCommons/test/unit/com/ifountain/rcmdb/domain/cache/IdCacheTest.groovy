...
public class IdCacheTest extends RapidCmdbWithCompassTestCase{
    ...
    public void testGetWithExistingInstances()
    {
        ...
        assertEquals(modelWithoutInheritance.name, entry.alias);
    ...
    public void testGetWithExistingHierarchyInstances()
    {
        ...
        assertEquals(childModel1.name, entryForChild1.alias);
        ...
        assertEquals(childModel1.name, entryForChild2.alias);
        ...
        assertEquals(childModel1.name, entryForParent.alias);
    ...
    public void testMarkAsDeleted()
    {
        ...
        assertEquals(childModel1.name, entryForChild1Instance1.alias);
        assertEquals(addedInstance.id, entryForChild1Instance1.id);

        assertTrue(entryForChild1Instance2.exist);
        assertEquals(childModel1.name, entryForChild1Instance2.alias);
        ...
        assertEquals(childModel1.name, entryForChild1Instance2AfterMarking.alias);
        ...
        assertEquals(childModel1.name, entryForChild1Instance2AfterMarkingNonexistant.alias);
