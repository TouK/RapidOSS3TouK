    ...
    <table style="height:100%" cellspacing="0" cellpadding="0"><tbody><tr>
        ...
        <td width="0%">
           <div style="vertical-align:bottom">
               <span style="font-size:12px;font-weight:bold;color:#083772;text-align:right;margin-bottom:5px;"></span>
               <a href="auth/signOut" style="font-size:13px;font-weight:bold;color:#083772;text-align:right;text-decoration:none">Logout</a>
           </div>
        </td>
    </tr></tbody></table>
</div>
...
<script type="text/javascript">
    ...
    var config = {  id:"filterTree", "url":"a2.xml", "rootTag":"Filters", "nodeId":"id", "nodeTag":"Filter",
