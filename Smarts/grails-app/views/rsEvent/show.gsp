        ...
        <table>
            <tbody>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsEvent.className}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsEvent.instanceName}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsEvent.category}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsEvent.classDisplayName}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsEvent.creationClassName}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsEvent.description}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsEvent.displayName}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsEvent.elementClassName}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsEvent.eventDisplayName}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsEvent.eventState}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsEvent.eventText}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsEvent.eventType}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsEvent.impact}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsEvent.inMaintenance}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsEvent.instanceDisplayName}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsEvent.occurrenceCount}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsEvent.sourceDomainName}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsEvent.troubleTicketID}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsEvent.userDefined1}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsEvent.userDefined10}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsEvent.userDefined2}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsEvent.userDefined3}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsEvent.userDefined4}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsEvent.userDefined5}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsEvent.userDefined6}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsEvent.userDefined7}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsEvent.userDefined8}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsEvent.userDefined9}</td>
