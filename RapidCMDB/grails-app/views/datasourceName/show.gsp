...
<html>
    <head>
        ...
        <title>Show DatasourceName</title>
    </head>
    <body>
        <div class="nav">
                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${datasourceName.id}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${datasourceName.name}</td>
