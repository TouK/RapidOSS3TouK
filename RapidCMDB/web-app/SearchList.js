YAHOO.rapidjs.rcmdb.SearchList = function(container, config) {
    this.id = null;
    this.url = null;
...
YAHOO.rapidjs.rcmdb.SearchList.prototype = {
    render : function() {
        var dh = YAHOO.ext.DomHelper;
        this.wrapper = dh.append(this.container, {tag: 'div', cls:'rcmdb-search'});
        this.header = dh.append(this.wrapper, {tag:'div', cls:'rcmdb-search-header',
        ...
        this.lineSizeSelector = this.header.dom.getElementsByTagName('select')[0];
    ...
    loadData : function(data) {
        ...
        this.rootNode = new YAHOO.rapidjs.rcmdb.RootSearchNode(data, this.contentPath);
        this.updateSearchData();
        this.updateBodyHeight();
    },
    ...
    showMask: function() {
        this.mask.setBounds(this.body.getX(), this.body.getY(), this.body.dom.clientWidth, this.body.dom.clientHeight);
...
YAHOO.rapidjs.rcmdb.SearchListPanel = function(searchList, config) {
    this.searchList = searchList;
    YAHOO.rapidjs.rcmdb.SearchListPanel.superclass.constructor.call(this, this.searchList.container, config);
};
YAHOO.extendX(YAHOO.rapidjs.rcmdb.SearchListPanel, YAHOO.ext.ContentPanel, {
    setSize: function(width, height)
    {
        this.searchList.resize(width, height);
        YAHOO.rapidjs.rcmdb.SearchListPanel.superclass.setSize.call(this, width, height)
    }
});