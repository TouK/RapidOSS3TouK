...
SearchQuery.add(group: defaultEventGroup, name: "All Events", query: "alias:*", sortProperty: "lastChangedAt", sortOrder: "desc", username:adminUser, isPublic:true, type:"event");
SearchQuery.add(group: defaultEventGroup, name: "Critical Events", query: "severity:1", sortProperty: "lastChangedAt", sortOrder: "desc", username:adminUser, isPublic:true, type:"event");
SearchQuery.add(group: defaultEventGroup, name: "Major Events", query: "severity:2", sortProperty: "lastChangedAt", sortOrder: "desc", username:adminUser, isPublic:true, type:"event");
SearchQuery.add(group: defaultEventGroup, name: "Minor Events", query: "severity:3", sortProperty: "lastChangedAt", sortOrder: "desc", username:adminUser, isPublic:true, type:"event");
SearchQuery.add(group: defaultEventGroup, name: "Unknown Events", query: "severity:4", sortProperty: "lastChangedAt", sortOrder: "desc", username:adminUser, isPublic:true, type:"event");
SearchQuery.add(group: defaultEventGroup, name: "Normal Events", query: "severity:5", sortProperty: "lastChangedAt", sortOrder: "desc", username:adminUser, isPublic:true, type:"event");
