...
<div class="body">
    ...
    <div class="list">
        <table>
            ...
            <tbody>
                <g:each in="${rsPortList}" status="i" var="rsPort">
                    <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                        
                        <td><g:link action="show" id="${rsPort.id}">${rsPort.id?.encodeAsHTML()}</g:link></td>
                        
                        <td>${rsPort.name?.encodeAsHTML()}</td>
