        ...
        <table>
            <tbody>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsSmartsNotification.source}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsSmartsNotification.state}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsSmartsNotification.willExpireAt}</td>
