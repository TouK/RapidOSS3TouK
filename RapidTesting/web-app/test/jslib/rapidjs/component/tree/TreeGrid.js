...
* USA.
*/
YAHOO.rapidjs.component.tree.TreeGrid = function(container,config){
...
YAHOO.rapidjs.component.tree.TreeGrid.prototype = {
	render:function(){
    	...
    	for(var index=0; index<numberOfCols; index++) {
	    	...
	    	var headerCell = new YAHOO.rapidjs.component.tree.TreeHeaderCell(this,headerRow, colLabel, colWidth, index);
	...
	handleData : function(data, expandAll){
		...
		this.rootNode = new YAHOO.rapidjs.component.tree.TreeRootNode(data, this.contentPath);
		if(expandAll == true){
			this.expandAll();
		}
		else{
