...
<div id="top" style="background-color:#BBD4F6;">
    <table style="height:100%" cellspacing="0" cellpadding="0"><tbody><tr>
        ...
        <td width="100%" style="vertical-align: bottom;;">
            <div class="yui-navset">
                <ul class="yui-nav" style="border-style: none">
                    ...
                    <li class="${request.uri.toString().indexOf('timeSeries/timeSeries.gsp') > -1 ? "selected" : ""}"><a href="${createLinkTo(file: 'timeSeries/timeSeries.gsp')}"><em>Time Series</em></a></li>
        ...
        <td width="0%">
        	<a href="/RapidSuite/help/timeSeriesHelp.gsp" target="_blank">
