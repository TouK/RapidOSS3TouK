...
<div id="top" style="background-color:#BBD4F6;">
    <table style="height:100%" cellspacing="0" cellpadding="0"><tbody><tr>
        ...
        <td width="100%" style="vertical-align: bottom;;">
            <div class="yui-navset">
                <ul class="yui-nav" style="border-style: none">
                    ...
                    <li class="${request.uri.toString().indexOf('development/activeModifications.gsp') > -1 ? "selected" : ""}"><a href="${createLinkTo(file: 'development/activeModifications.gsp')}"><em>Modifications</em></a></li>
        ...
        <td width="0%">
        	<a href="/RapidSuite/help/developmentHelp.gsp" target="_blank">
