...
class SmartsHSRPGroup  extends RsTopologyObject {
    ...
    static searchable = {
        except = ["errors", "__operation_class__", "__is_federated_properties_loaded__", "computerSystems", "endPoints"];
    ...
    static relations = [
        ...
        computerSystems:[type:SmartsComputerSystem, reverseName:"hsrpGroup", isMany:true]
    
        ,endPoints:[type:SmartsHSRPEndpoint, reverseName:"hsrpGroup", isMany:true]
    ...
    static transients = ["errors", "__operation_class__", "__is_federated_properties_loaded__", "computerSystems", "endPoints"];
