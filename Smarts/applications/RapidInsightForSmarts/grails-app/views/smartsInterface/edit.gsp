...
<head>
    ...
    <title>Edit SmartsInterface</title>
</head>
<body>
<div class="nav">
            ...
            <table>
                <tbody>
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" class="value ${hasErrors(bean:smartsInterface,field:'layeredOver','errors')}">
...
<g:each var="l" in="${smartsInterface?.layeredOver?}">
    <li style="margin-bottom:3px;">
        ...
        <g:link class="delete" action="removeRelation" params="['id':smartsInterface?.id, 'relationName':'layeredOver', 'relatedObjectId':l.id]"></g:link>
    </li>
</g:each>
</ul>
<g:link params="['id':smartsInterface?.id, 'relationName':'layeredOver']" action="addTo">Add SmartsComputerSystemComponent</g:link>
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" class="value ${hasErrors(bean:smartsInterface,field:'memberOfGroup','errors')}">
                            
<ul>
<g:each var="m" in="${smartsInterface?.memberOfGroup?}">
    <li style="margin-bottom:3px;">
        <g:link controller="rsGroup" action="show" id="${m.id}">${m}</g:link>
        <g:link class="delete" action="removeRelation" params="['id':smartsInterface?.id, 'relationName':'memberOfGroup', 'relatedObjectId':m.id]"></g:link>
    </li>
</g:each>
</ul>
<g:link params="['id':smartsInterface?.id, 'relationName':'memberOfGroup']" action="addTo">Add RsGroup</g:link>
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" class="value ${hasErrors(bean:smartsInterface,field:'underlying','errors')}">
                            
<ul>
<g:each var="u" in="${smartsInterface?.underlying?}">
    <li style="margin-bottom:3px;">
        <g:link controller="smartsComputerSystemComponent" action="show" id="${u.id}">${u}</g:link>
        <g:link class="delete" action="removeRelation" params="['id':smartsInterface?.id, 'relationName':'underlying', 'relatedObjectId':u.id]"></g:link>
    </li>
</g:each>
</ul>
<g:link params="['id':smartsInterface?.id, 'relationName':'underlying']" action="addTo">Add SmartsComputerSystemComponent</g:link>
