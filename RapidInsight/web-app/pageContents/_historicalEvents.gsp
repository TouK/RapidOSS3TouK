<script>
    ...
    eventList.renderCellFunction = function(key, value, data, el){
        ...
        else if(data.rsAlias == "RsRiHistoricalEvent" && (key == "elementName" || key=="identifier")){
    ...
    filterTree.addToolbarButton({
        ...
        click:function() {
            ...
            queryGroupForm.show(createURL('queryGroupForm.gsp', {mode:'create', type:'historicalEvent'}));
    ...
    filterTree.addToolbarButton({
        ...
        click:function() {
            ...
            queryForm.show(createURL('queryForm.gsp', {mode:'create', type:'historicalEvent', searchComponentType:'list'}));
        }
    });
    filterTree.poll();
    eventList.poll();
