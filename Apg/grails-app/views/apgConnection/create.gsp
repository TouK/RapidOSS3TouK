            ...
            <table>
                <tbody>
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" class="value ${hasErrors(bean: apgConnection, field: 'username', 'errors')}">
                            <input type="text" class="inputtextfield" id="username" name="username" value="${fieldValue(bean: apgConnection, field: 'username')}"/>
                        </td>
                    </tr>
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" class="value ${hasErrors(bean: apgConnection, field: 'userPassword', 'errors')}">
                            <input type="password" class="inputtextfield" id="password" name="userPassword" value="${fieldValue(bean: apgConnection, field: 'userPassword')}"/>
                        </td>
                    </tr>
