...
public class CompassClassMapping {
    ...
    private String supportUnmarshall;
    ...
    public String getSupportUnmarshall() {
        return supportUnmarshall;
    }

    public void setSupportUnmarshall(String supportUnmarshall) {
    ...
    public String toString() {
        return "CompassClassMapping: mappedClass=[" + mappedClass + "],  mappedClassSuperClass=[" + mappedClassSuperClass + "], alias=[" + alias + "], subIndex=[" + subIndex + "], root=[" + root + "], poly=[" + poly + "], extend=[" + extend + "], propertyMappings=[" + propertyMappings + "]";
    }
}
