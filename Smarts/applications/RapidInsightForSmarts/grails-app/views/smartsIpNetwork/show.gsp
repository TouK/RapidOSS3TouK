...
<head>
    ...
    <title>Show SmartsIpNetwork</title>
</head>
<body>
<div class="nav">
        ...
        <table>
            <tbody>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${smartsIpNetwork.id}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${smartsIpNetwork.name}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${smartsIpNetwork.className}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${smartsIpNetwork.description}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${smartsIpNetwork.displayName}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${smartsIpNetwork.isManaged}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${smartsIpNetwork.netmask}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${smartsIpNetwork.networkNumber}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${smartsIpNetwork.rsDatasource}</td>
