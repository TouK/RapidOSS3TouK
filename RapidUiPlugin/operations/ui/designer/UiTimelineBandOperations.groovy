    ...
    public static Map metaData()
    {
        Map metaData = [
                ...
                propertyConfiguration: [
                        ...
                        date:[descr:"Parameter to make sure the timeline starts out showing the events immediately without requiring the user to pan first. Band is positioned at the specified date."],
