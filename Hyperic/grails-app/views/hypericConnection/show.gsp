...
<head>
    ...
    <title>Show HypericConnection</title>
</head>
<body>
<div class="nav">
        ...
        <table>
            <tbody>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${hypericConnection.name}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${hypericConnection.maxNumberOfConnections}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${hypericConnection.baseUrl}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${hypericConnection.username}</td>
