...
<div class="body">
    ...
    <div class="list">
        <table>
            ...
            <tbody>
                <g:each in="${rsVlanList}" status="i" var="rsVlan">
                    <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                        
                        <td><g:link action="show" id="${rsVlan.id}">${rsVlan.id?.encodeAsHTML()}</g:link></td>
                        
                        <td>${rsVlan.name?.encodeAsHTML()}</td>
