...
<head>
    ...
    <title>Show RsManagementSystem</title>
</head>
<body>
<div class="nav">
        ...
        <table>
            <tbody>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsManagementSystem.id}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsManagementSystem.name}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsManagementSystem.lastPolledAt}</td>
