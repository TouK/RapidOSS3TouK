...
YAHOO.rapidjs.component.tool.SettingsTool = function(container, component) {
	...
	this.dialog = new YAHOO.rapidjs.component.Dialog({width:300,height:100,
    ...
    '<table width="100%">' +
    '<tr><td width="50%"><label>Polling Interval:</label></td><td width="50%"><input type="textbox" name="PollingInterval" style="width:100px"/></td></tr>'+
    '</table>'
