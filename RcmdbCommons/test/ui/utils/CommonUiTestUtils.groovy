...
class CommonUiTestUtils {
    ...
    {
            Assert.assertEquals("Script could not be cretaed. Reason :${CommonUiTestUtils.getPageErrorMessage(selenium)}".toString(), expectedMessage, getPageMessage(selenium))
    }
