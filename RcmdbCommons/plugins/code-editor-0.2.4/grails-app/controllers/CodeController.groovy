            ...
            else
            {
                ...
                builder.Files(rootDir:dirRelativePath)
                {
                    ...
                    dir.listFiles().each{File subFile->
                        ...
                        {
                            builder.File(file:subFilePath, displayName:subFile.getName(), type:subFileType, isDir:subFile.isDirectory());
                        }
                        else if(filters.contains(subFileType))
                        {
                            builder.File(file:subFilePath, displayName:subFile.getName(), isDir:subFile.isDirectory());
                        }
                    }
                }
                render(text:sw.toString(), contentType:'text/xml');
