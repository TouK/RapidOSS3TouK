        ...
        <table>
            <tbody>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${author.name}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${author.address}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${author.birthDate}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${author.email}</td>
                    
                </tr>
                
                <tr class="prop">
                    <td valign="top" class="name">numberOfBooks:</td>
                    
                    <td valign="top" class="value">${author.numberOfBooks}</td>
