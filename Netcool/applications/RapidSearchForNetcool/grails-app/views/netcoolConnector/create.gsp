...
<head>
    ...
    <title>Create NetcoolConnector</title>
</head>
<body>
<div class="nav">
            ...
            <table>
                <tbody>
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" class="value ${hasErrors(bean: netcoolConnector, field: 'name', 'errors')}">
                            <input type="text" id="name" class="inputtextfield" name="name" value="${fieldValue(bean: netcoolConnector, field: 'name')}"/>
                        </td>
                    </tr>
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" class="value ${hasErrors(bean: netcoolConnection, field: 'host', 'errors')}">
                            <input type="text" id="host" class="inputtextfield" name="host" value="${fieldValue(bean: netcoolConnection, field: 'host')}"/>
                        </td>
                    </tr>
