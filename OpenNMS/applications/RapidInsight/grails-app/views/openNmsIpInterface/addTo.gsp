...
<html>
    <head>
        ...
        <title>Add To OpenNmsIpInterface</title>
    </head>
    <body>
        <div class="nav">
        ...
        <div class="body">
            <h1>Add To OpenNmsIpInterface</h1>
                        ...
                        <tbody>
                            <tr class="prop">
                                <td valign="top" class="name">
                                    ...
                                    <label for="${relationName}">${com.ifountain.rcmdb.domain.util.DomainClassUtils.getStaticMapVariable(openNmsIpInterface.class, "relations")[relationName]?.type.getName()}:</label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: openNmsIpInterface, field: relationName, 'errors')}">
