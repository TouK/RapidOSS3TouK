...
class HypericServerController {
    ...
    def delete = {
        ...
        if (hypericServer) {
            try {
                ...
                def errors = [message(code: "default.couldnot.delete", args: [HypericServer, hypericServer])]
                flash.errors = errors;
    ...
    def addTo = {
        ...
        if (!hypericServer) {
            ...
            if (relationName) {
                def otherClass = com.ifountain.rcmdb.domain.util.DomainClassUtils.getStaticMapVariable(hypericServer.class, "relations")[relationName].type;
