...
<rui:searchList id="searchList" url="search?format=xml&searchIn=RsEvent" queryParameter="query" rootTag="Objects" contentPath="Object"
         keyAttribute="id" totalCountAttribute="total" offsetAttribute="offset" sortOrderAttribute="sortOrder" lineSize="3" title="Events"
         defaultFields="['name']">
    <rui:slMenuItems>
        <rui:slMenuItem id="acknowledge" label="Acknowledge" visible="data.acknowledged != 'true'"></rui:slMenuItem>
        <rui:slMenuItem id="unacknowledge" label="Unacknowledge" visible="data.acknowledged == 'true'"></rui:slMenuItem>
        <rui:slMenuItem id="takeOwnership" label="Take Ownership"></rui:slMenuItem>
        <rui:slMenuItem id="releaseOwnership" label="Release Ownership"></rui:slMenuItem>
    ...
    <rui:slPropertyMenuItems>
         ...
         <rui:slMenuItem id="browse" label="Browse" visible="key == 'instanceName' || key == 'elementName'"></rui:slMenuItem>
    </rui:slPropertyMenuItems>
    <rui:slImages>
    ...
    <rui:slFields>
        ...
        %>
        <rui:slField exp="data.rsAlias == 'RsSmartsNotification'" fields="${smartsEventFields}"></rui:slField>
    </rui:slFields>
</rui:searchList>
