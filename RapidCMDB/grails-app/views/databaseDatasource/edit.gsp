...
<html>
    <head>
        ...
        <title>Edit DatabaseDatasource</title>
    </head>
    <body>
        <div class="nav">
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:databaseDatasource,field:'name','errors')}">
                                    <input type="text" id="name" name="name" value="${fieldValue(bean:databaseDatasource,field:'name')}"/>
                                </td>
                            </tr> 
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:databaseDatasource,field:'connection','errors')}">
                                    <g:select optionKey="id" from="${connection.DatabaseConnection.list()}" name="connection.id" value="${databaseDatasource?.connection?.id}" ></g:select>
                                </td>
                            </tr> 
