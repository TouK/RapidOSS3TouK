...
class ModelGenerator
{
    ...
    def generateModel(Model model, Map generatedModels)
    {
        ...
        def bindings = ["datasourceInfo":new DatasourceInfo(model), "propertyInfo":new PropertyInfo(model)];
...
class DatasourceInfo
{
    ...
    public DatasourceInfo(Model model)
    {
...
class PropertyInfo
{
    ...
    def constraints = [:];
    def propertyList = [];
    public PropertyInfo(Model model)
    {
