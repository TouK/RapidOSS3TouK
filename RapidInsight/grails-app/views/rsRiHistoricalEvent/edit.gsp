...
<head>
    ...
    <title>Edit RsRiHistoricalEvent</title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <h1>Edit RsRiHistoricalEvent</h1>
            ...
            <table>
                <tbody>
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" class="value ${hasErrors(bean:rsRiHistoricalEvent,field:'elementId','errors')}">
                            <input type="text" id="elementId" name="elementId" value="${fieldValue(bean:rsRiHistoricalEvent,field:'elementId')}" />
                        </td>
                    </tr>
