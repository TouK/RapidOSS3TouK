 ...
 * @param {Number} placement (optional) Either YAHOO.ext.SplitBar.LEFT or YAHOO.ext.SplitBar.RIGHT for horizontal or
                        YAHOO.rapidjs.component.SplitBar.TOP or YAHOO.rapidjs.component.SplitBar.BOTTOM for vertical. (By default, this is determined automatically by the intial position
                        position of the SplitBar).
 */
YAHOO.rapidjs.component.Split = function(dragElement, resizingElement, orientation, placement){
    ...
    /**
     * @private
     * The orientation of the split. Either YAHOO.rapidjs.component.Split.HORIZONTAL or YAHOO.rapidjs.component.Split.VERTICAL. (Defaults to HORIZONTAL)
     * Note: If this is changed after creating the SplitBar, the placement property must be manually updated
     * @type Number
     */
    this.orientation = orientation || YAHOO.rapidjs.component.Split.HORIZONTAL;
    ...
    /** @private */
    this.proxy = YAHOO.rapidjs.component.Split.createProxy(this.orientation);
     ...
     */
    this.adapter = new YAHOO.rapidjs.component.Split.BasicLayoutAdapter();
    this.adapter.init(this);

    if(this.orientation == YAHOO.rapidjs.component.Split.HORIZONTAL){
        /** @private */
        this.placement = placement || (this.el.getX() > this.resizingEl.getX() ? YAHOO.rapidjs.component.Split.LEFT : YAHOO.rapidjs.component.Split.RIGHT);
        this.el.setStyle('cursor', 'e-resize');
    }else{
        /** @private */
        this.placement = placement || (this.el.getY() > this.resizingEl.getY() ? YAHOO.rapidjs.component.Split.TOP : YAHOO.rapidjs.component.Split.BOTTOM);
    ...
    this.events = {
         ...
         * @param {YAHOO.rapidjs.component.Split} this
...
YAHOO.lang.extend(YAHOO.rapidjs.component.Split, YAHOO.ext.util.Observable, {
    onStartProxyDrag : function(x, y){
        this.fireEvent('beforeresize', this);
        if(this.useShim){
            if(!this.shim){
                this.shim = YAHOO.rapidjs.component.Split.createShim();
            }
        ...
        if(this.orientation == YAHOO.rapidjs.component.Split.HORIZONTAL){
            ...
            this.dd.setXConstraint(
                this.placement == YAHOO.rapidjs.component.Split.LEFT ? c1 : c2,
                this.placement == YAHOO.rapidjs.component.Split.LEFT ? c2 : c1
            );
            ...
            this.dd.setYConstraint(
                this.placement == YAHOO.rapidjs.component.Split.TOP ? c1 : c2,
                this.placement == YAHOO.rapidjs.component.Split.TOP ? c2 : c1
            );
         }
    ...
    onEndProxyDrag : function(e){
        ...
        if(this.orientation == YAHOO.rapidjs.component.Split.HORIZONTAL){
            newSize = this.dragSpecs.startSize +
                (this.placement == YAHOO.rapidjs.component.Split.LEFT ?
                    endPoint[0] - this.dragSpecs.startPoint[0] :
                    this.dragSpecs.startPoint[0] - endPoint[0]
                );
        }else{
            newSize = this.dragSpecs.startSize +
                (this.placement == YAHOO.rapidjs.component.Split.TOP ?
 ...
 */
YAHOO.rapidjs.component.Split.createShim = function(){
 ...
 */
YAHOO.rapidjs.component.Split.createProxy = function(orientation){
    ...
    if(orientation == YAHOO.rapidjs.component.Split.HORIZONTAL){
...
/**
 * @class YAHOO.rapidjs.component.Split.BasicLayoutAdapter
 * Default Adapter. It assumes the splitter and resizing element are not positioned
 * elements and only gets/sets the width of the element. Generally used for table based layouts.
 */
YAHOO.rapidjs.component.Split.BasicLayoutAdapter = function(){
};

YAHOO.rapidjs.component.Split.BasicLayoutAdapter.prototype = {
    // do nothing for now
    init : function(s){
     ...
     * @param {YAHOO.rapidjs.component.Split} s The SplitBar using this adapter
     */
     getElementSize : function(s){
        if(s.orientation == YAHOO.rapidjs.component.Split.HORIZONTAL){
...
/**
 *@class YAHOO.rapidjs.component.Split.AbsoluteLayoutAdapter
 * @extends YAHOO.rapidjs.component.Split.BasicLayoutAdapter
 ...
 */
YAHOO.rapidjs.component.Split.AbsoluteLayoutAdapter = function(container){
    this.basic = new YAHOO.rapidjs.component.Split.BasicLayoutAdapter();
    this.container = getEl(container);
}

YAHOO.rapidjs.component.Split.AbsoluteLayoutAdapter.prototype = {
    init : function(s){
        this.basic.init(s);
    ...
    moveSplitter : function(s){
        var yes = YAHOO.rapidjs.component.Split;
        switch(s.placement){
            case yes.LEFT:
 ...
 * @type Number
 */
YAHOO.rapidjs.component.Split.VERTICAL = 1;
 ...
 * @type Number
 */
YAHOO.rapidjs.component.Split.HORIZONTAL = 2;
 ...
 * @type Number
 */
YAHOO.rapidjs.component.Split.LEFT = 1;
 ...
 * @type Number
 */
YAHOO.rapidjs.component.Split.RIGHT = 2;
 ...
 * @type Number
 */
YAHOO.rapidjs.component.Split.TOP = 3;
 ...
 * @type Number
 */
YAHOO.rapidjs.component.Split.BOTTOM = 4;
