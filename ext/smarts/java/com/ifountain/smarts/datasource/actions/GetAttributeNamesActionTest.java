...
public class GetAttributeNamesActionTest extends SmartsTestCase {
    ...
    public void testExecute() throws Exception {
        ...
        action.execute(datasource);
        String[] attNames = action.getAttributeNames();
        SmRepositoryInterfaceHandler domainManager = datasource.getDomainManager();
        assertTrue(Arrays.equals(domainManager.getAttributeNames(className), attNames));
