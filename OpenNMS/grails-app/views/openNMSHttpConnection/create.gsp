...
<html>
    <head>
        ...
        <title>Create OpenNMSHttpConnection</title>
    </head>
    <body>
        <div class="nav">
        ...
        <div class="body">
            <h1>Create OpenNMSHttpConnection</h1>
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:openNMSHttpConnection,field:'name','errors')}">
                                    <input type="text" class="inputtextfield" id="name" name="name" value="${fieldValue(bean:openNMSHttpConnection,field:'name')}"/>
                                </td>
                            </tr> 
