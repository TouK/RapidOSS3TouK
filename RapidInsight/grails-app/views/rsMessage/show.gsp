        ...
        <table>
            <tbody>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsMessage.id}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsMessage.eventId}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsMessage.to}</td>
