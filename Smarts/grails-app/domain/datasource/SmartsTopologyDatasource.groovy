...
class SmartsTopologyDatasource extends BaseListeningDatasource{
    ...
    def onLoad = {
        this.adapter = new BaseTopologyAdapter(getProperty("connection").name, reconnectInterval*1000, Logger.getRootLogger());
    }
    ...
    def getListeningAdapter(Map params){
        ...
        return new SmartsTopologyListeningAdapter(getProperty("connection").name, reconnectInterval*1000, Logger.getRootLogger(), smartsSubscribeParamsList as SmartsSubscribeParameters[]);
    }
