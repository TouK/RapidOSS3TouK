...
<head>
    ...
    <title>Show RsSmartsHistoricalNotification</title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <h1>Show RsSmartsHistoricalNotification</h1>
        ...
        <table>
            <tbody>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsSmartsHistoricalNotification.id}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsSmartsHistoricalNotification.category}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsSmartsHistoricalNotification.classDisplayName}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsSmartsHistoricalNotification.creationClassName}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsSmartsHistoricalNotification.description}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsSmartsHistoricalNotification.displayName}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsSmartsHistoricalNotification.elementClassName}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsSmartsHistoricalNotification.elementName}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsSmartsHistoricalNotification.eventDisplayName}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsSmartsHistoricalNotification.eventName}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsSmartsHistoricalNotification.eventState}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsSmartsHistoricalNotification.eventText}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsSmartsHistoricalNotification.eventType}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsSmartsHistoricalNotification.inMaintenance}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsSmartsHistoricalNotification.instanceDisplayName}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsSmartsHistoricalNotification.instanceName}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsSmartsHistoricalNotification.owner}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsSmartsHistoricalNotification.rsDatasource}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsSmartsHistoricalNotification.severity}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsSmartsHistoricalNotification.userDefined1}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsSmartsHistoricalNotification.userDefined10}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsSmartsHistoricalNotification.userDefined2}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsSmartsHistoricalNotification.userDefined3}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsSmartsHistoricalNotification.userDefined4}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsSmartsHistoricalNotification.userDefined5}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsSmartsHistoricalNotification.userDefined6}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsSmartsHistoricalNotification.userDefined7}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${rsSmartsHistoricalNotification.userDefined8}</td>
    ...
    <div class="buttons">
        <g:form>
            <input type="hidden" name="id" value="${rsSmartsHistoricalNotification?.id}"/>
