...
<head>
    ...
    <title>Show ApgReportDatasource</title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <h1>Show ApgReportDatasource</h1>
        ...
        <table>
            <tbody>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${apgReportDatasource.name}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value"><g:link controller="apgConnection" action="show" id="${apgReportDatasource?.connection?.id}">${apgReportDatasource?.connection}</g:link></td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${apgReportDatasource.reconnectInterval} sec.</td>
