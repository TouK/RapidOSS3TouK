...
<head>
    ...
    <title>Show NetcoolConnector</title>
</head>
<body>
<div class="nav">
        ...
        <table>
            <tbody>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${netcoolConnection?.userPassword}</td>
                    
                </tr>

                <tr class="prop">
                    <td valign="top" class="name">logLevel:</td>

                    <td valign="top" class="value">${netcoolConnector.logLevel}</td>
