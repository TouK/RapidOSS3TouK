...
<html>
    <head>
        ...
        <title>Add To RsManagementSystem</title>
    </head>
    <body>
        <div class="nav">
        ...
        <div class="body">
            <h1>Add To RsManagementSystem</h1>
                        ...
                        <tbody>
                            <tr class="prop">
                                <td valign="top" class="name">
                                    ...
                                    <label for="${relationName}">${com.ifountain.rcmdb.domain.util.DomainClassUtils.getStaticMapVariable(rsManagementSystem.class, "relations")[relationName]?.type.getName()}:</label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: rsManagementSystem, field: relationName, 'errors')}">
