...
class NetcoolJournalController {
    ...
    def delete = {
        ...
        if(netcoolJournal) {
            try{
                ...
                addError("default.couldnot.delete", [NetcoolJournal, netcoolJournal])
    ...
    def addTo = {
        ...
        if(!netcoolJournal){
            ...
            if(relationName){
                def otherClass = DomainClassUtils.getStaticMapVariable(NetcoolJournal, "relations")[relationName].type;
    ...
    def removeRelation = {
        ...
        if(!netcoolJournal) {
            ...
            def otherClass = com.ifountain.rcmdb.domain.util.DomainClassUtils.getStaticMapVariable(NetcoolJournal, "relations")[relationName].type;
            if(otherClass){
                def res = otherClass.metaClass.invokeStaticMethod(otherClass, "get", params.relatedObjectId.toLong());
                if(res){
                      def relationMap = [:];
